...
public class OpenCensusAgentTraceExporterServiceIntTest extends SpringTestBase {
    ...
    public void testGrpcRequest() {
        ...
        await().atMost(15, TimeUnit.SECONDS).untilAsserted(() -> {
            assertThat(fakeOcAgentTraceServiceGrpc.getExportTraceServiceRequests()).hasSize(2);
            assertThat(fakeOcAgentTraceServiceGrpc.getExportTraceServiceRequests().get(1).getSpansList().get(0).getName().getValue()).isEqualTo(SPAN_NAME);
        });
    }
